...
C:load_libs"code"
    ...
    for k,v,tab,has_un in pairs{...}do
        ...
        Runtime.build("bitD."..bt[v],bit32[bt[v]] or idiv_func ,1)
        --end
        ...
        Operators[v]=function()--operator detected!
            ...
            Cssc.inject(is_un and ""or",",2,not is_un and k or nil, is_un and p_un or nil)--inject found operator Control.Cdata.opts[","][1]
