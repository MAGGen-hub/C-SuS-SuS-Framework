...
local base_path=[[cssf_final/out/debug/minify/]]local cssf,A,S,T,E,Cp,E_ENV,_={},assert,string,table,"cssf load failed because of missing libruary method!",function()end
