...
local base_path=[[cssc_final/out/debug/]]local cssc,A,S,T,E,Cp,E_ENV,_={},assert,string,table,"cssc load failed because of missing libruary method!",function()end
