local Sm,Ti,Tr,Tu,Gt,Gl,Cp=ENV(2,7,9,10,12,20,22)local l,O,K,L,c,M=C:load_libs"text.dual_queue""base""parser""iterator""space_handler"().code.lua("base",Operators,Words)"struct"()(5,-1)L("cdata",O,l,Cp)().common"event"("level",l)L=nil
