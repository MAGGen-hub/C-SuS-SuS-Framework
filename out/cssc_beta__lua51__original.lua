...
local TC,TS,Cl=function(s,o,f)for k,v in Gp(s)do o[k]=f and o[k]or v end end,function(t,o)o=o or{}for k,v in Gp(t)do o[v]=k end return o end,function(...)local r={}for k,v in Gp{...}do Ti(r,E_ENV[v])end return Tu(r)end
