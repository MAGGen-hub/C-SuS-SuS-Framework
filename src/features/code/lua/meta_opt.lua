...
local call_prew,call_nxt = t_swap{__STRING__,__CLOSE_BREAKET__,__WORD__},t_swap{__STRING__,__OPEN_BREAKET__}
...
local stat_end_prew,stat_end_nxt=t_swap{__WORD__,__CLOSE_BREAKET__,__STRING__,__VALUE__,__NUMBER__},t_swap{__WORD__,__KEYWORD__,__VALUE__,__NUMBER__}
