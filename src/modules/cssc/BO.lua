    ...
    for k,v,tab,has_un in pairs{...}do
        ...
        Control.Operators[v]=function()--operator detected!
            ...
            Control.Event.reg("all",function(obj,tp)--error check after
                ...
                if tp==__KEYWORD__ and Control.Result[#Control.Result]~="function" or  tp==__CLOSE_BREAKET__ or tp==__OPERATOR__ and not Control.Cdata[#Control.Cdata][3] then Control.error("Unexpected '%s' after '%s'!",obj,v) end
