...
t_swap{shl='<<',shr='>>',bxor='~',bor='|',band='&',idiv='//'},t_swap{__OPERATOR__,__OPEN_BREAKET__,__KEYWORD__},"__cssc__bit_"..(direct and"d_"or""), --priority base, unary priority,bitw funcs
...
C:load_lib"code.syntax_loader"(stx,{O=function(...)--reg syntax
    for k,v,tab,has_un in pairs{...}do
        ...
        else Runtime.build("bitD."..bt[v],bit32[bt[v]] or idiv_func ,__TRUE__) end
