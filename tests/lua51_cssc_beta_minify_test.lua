...
assert(lzss_minif,"Unable to minify lzss src")

local compressed_lzss_src=lzss_minif.compress(lzss_src)
local decompressed_lzss_src=lzss_minif.decompress(compressed_lzss_src)
assert(decompressed_lzss_src == lzss_src,"Error minifyed lzss compress/decompress output not equal to input!")
print("Minify lzss test complete.")
