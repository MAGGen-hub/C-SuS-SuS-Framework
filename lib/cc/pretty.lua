...
local term = require "cc.term"
local expect = require "cc.expect"
local expect, field = expect.expect, expect.field
local unpack = table.unpack or unpack

local type, getmetatable, setmetatable, colours, str_write, tostring = type, getmetatable, setmetatable, setmetatable({},{__index=function()return 1 end}), function(str)io.stdout:write(str)end, tostring
...
local function pretty_impl(obj, options, tracking)
    ...
    elseif next(obj) == nil then
        ...
        tracking[obj] = nil
        return group(concat(obrace, nest(2, concat(unpack(doc, 1, doc.n))), space_line, cbrace))
    end
end
